      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="房屋名称" name="title">
              ...
              <a-col span="24">
                <a-form-item label="房屋简介">
                  <a-textarea placeholder="请输入" v-model:value="modal.form.description"></a-textarea>
                </a-form-item>
              </a-col>              <a-col span="12">
              <a-form-item label="租赁方式">
                <a-select placeholder="请选择" allowClear v-model:value="modal.form.zlfs">
                  <a-select-option key="年租" value="年租">年租</a-select-option>
                  <a-select-option key="月租" value="月租">月租</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
              <a-col span="12">
                <a-form-item label="月租价格" name="price">
                  <a-input-number  placeholder="请输入" :min="0" v-model:value="modal.form.price" style="width: 100%;"></a-input-number>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="押金" name="price">
                  <a-input-number  placeholder="请输入" :min="0" v-model:value="modal.form.yajin" style="width: 100%;"></a-input-number>
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="小区">
                  <a-input  placeholder="请输入" v-model:value="modal.form.xiaoqu" style="width: 100%;"></a-input>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="朝向">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.chaoxiang">
                    <a-select-option key="南北" value="南北">南北</a-select-option>
                    <a-select-option key="东西" value="东西">东西</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="楼层">
                  <a-input  placeholder="请输入" v-model:value="modal.form.louceng" style="width: 100%;"></a-input>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="面积">
                  <a-input  placeholder="请输入" v-model:value="modal.form.mianji" style="width: 100%;"></a-input>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="联系电话">
                  <a-input  placeholder="请输入" v-model:value="modal.form.mobile" style="width: 100%;"></a-input>
                </a-form-item>
              </a-col>
              <a-col span="12">
...
const handleOk = () => {
  myform.value
      ...
      .then(() => {
        ...
        formData.append('zlfs', modal.form.zlfs || '')
        formData.append('chaoxiang', modal.form.chaoxiang || '')
        formData.append('louceng', modal.form.louceng || '')
        formData.append('mianji', modal.form.mianji || '')
        formData.append('xiaoqu', modal.form.xiaoqu || '')
        formData.append('yajin', modal.form.yajin || '')
