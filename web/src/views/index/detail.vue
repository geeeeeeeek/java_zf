            ...
            <div class="thing-infos">
              ...
              <div class="thing-info-box">
                <div class="thing-state">
                  <span class="state hidden-sm">房屋状态</span>
                  <span>出租中</span>
                </div>
                <h1 class="thing-name">{{ detailData.title }}</h1>
                <span>
                  <span class="a-price">{{detailData.price}}元/月</span>
                </span>
                <div class="translators flex-view" style="">
                  <span>租赁方式：</span>
                  <span class="name">{{ detailData.zlfs }}</span>
                </div>
                <div class="translators flex-view" style="">
                  <span>楼层：</span>
                  <span class="name">{{ detailData.louceng }}</span>
                </div>
                <div class="translators flex-view" style="">
                  <span>朝向：</span>
                  <span class="name">{{ detailData.chaoxiang }}</span>
                </div>
                <div class="translators flex-view" style="">
                  <span>小区：</span>
                  <span class="name">{{ detailData.xiaoqu }}</span>
                </div>
                <div class="translators flex-view" style="">
                  <span>地址：</span>
            ...
            <div class="things">
              <div class="thing-item thing-item" v-for="item in recommendData" @click="handleDetail(item)">
                ...
                <div class="info-view">
                  ...
                  <span>
                    <span class="a-price">{{item.zlfs}} - {{item.price}}元/月</span>
                  </span>
                </div>
              </div>
            </div>
...
const handleOrder =(detailData)=> {
  ...
  Modal.info({
    title: '联系电话：'+detailData.mobile, // 此时 title 的改变，会同步更新 confirm 中的 title
  });
}
